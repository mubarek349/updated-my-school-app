-- AlterTable
ALTER TABLE `finalexamresult` ADD COLUMN `certificateUrl` VARCHAR(191) NULL,
    ADD COLUMN `dateOfDownloadingCertificate` DATETIME(3) NULL,
    ADD COLUMN `updationProhibited` BOOLEAN NOT NULL DEFAULT false;

-- AlterTable
ALTER TABLE `subjectpackage` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
