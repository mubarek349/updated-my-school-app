    ...
    >
      ...
      <div className="flex flex-col overflow-auto">
              ...
              <BreadcrumbItem>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <BreadcrumbLink
                      className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200"
                      href={`/en/student/${chatId}/${courseId}`}
                    >
        ...
        <AnimatePresence>
          {isLoading ? (
            <motion.div
              className="flex items-center justify-center min-h-[50vh] bg-gradient-to-r from-yellow-100 to-yellow-200 dark:from-yellow-900 dark:to-yellow-800 rounded-xl"
              variants={itemVariants}
              initial="hidden"
              animate="visible"
            >
              <div className="animate-pulse w-4/5 h-96 rounded-lg bg-yellow-300/50 dark:bg-yellow-700/50" />
            </motion.div>
          ) : error ? (
            <motion.div
